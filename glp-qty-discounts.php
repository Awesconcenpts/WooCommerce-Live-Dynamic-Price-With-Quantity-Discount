<div class="tier-pricing">
	<table class="table" data-metal="<?php echo $_data['metal']; ?>" data-id="<?php echo $_data['id']; ?>">
		<thead>
			...
			<tr >
				<?php /*?><td colspan="4">
				For larger quantities please call us on <strong><?php echo get_option('glp_contact_more_qty'); ?></strong><br>to discuss todays rates.
				</td><?php */?>
			</tr>
		</tfoot>
	</table>
